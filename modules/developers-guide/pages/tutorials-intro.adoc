...
The sample program in the link:quickstart/hackathon-quick-start{outfilesuffix}[Quick start] illustrated the basic work flow for creating projects and deploying sample code to run on an {IC} node.
